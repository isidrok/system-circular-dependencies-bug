System.register(['./core-js.js'], function (exports) {
	'use strict';
	return {
		setters: [function () {}],
		execute: function () {
			...
			*/
			...
			var react = exports('b', createCommonjsModule(function (module) {
			...
			var reactDom = exports('r', createCommonjsModule(function (module) {
